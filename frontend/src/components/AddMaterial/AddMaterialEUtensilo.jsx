...
const AddMaterialEUtensilio = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedDate = ultimo_pedido ? new Date(ultimo_pedido).toISOString().split('T')[0] : '';
    ...
    try {
      ...
      const response = await api.post("/materialeutensilios/create", materialData);
      ...
      if (error.response && error.response.data && error.response.data.error) {
        ...
        alert("Erro ao adicionar material. Verifique os dados e tente novamente.");
      }
    }
  };
    ...
    <div className="form-container">
      <form className="form-add" onSubmit={handleSubmit}>
        ...
        <div className="input-three-columns">
          ...
          <div className="custom-select-wrapper">
            <select value={status_material} onChange={(e) => setStatus_material(e.target.value)}>
